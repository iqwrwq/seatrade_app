...
// Beschreibt das Ergebnis eines RadarRequests um die angegebene Position, d.h. Informatioen zu allen umgebeenen Feldern
...
public class RadarScreen implements Serializable {
	...
	public Ground getGround(RadarDirection rd) {
		return measures[rd.ordinal()].getGround();
	}

	public boolean hasShip(RadarDirection rd) {
		return measures[rd.ordinal()].isHasShip();
	}
